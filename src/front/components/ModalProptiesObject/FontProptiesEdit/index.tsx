    ...
    <Secssion>
      ...
      <Content>
        ...
        <InputWrapper>
          <label>Bold</label>
          <TogleSwitch
            setValue={props.propties.bold}
            getValue={handleFontBold}
          />
        </InputWrapper>
        ...
        <InputWrapper>
          <label>Italic</label>
          <TogleSwitch
            setValue={props.propties.italic}
            getValue={handleFontItalic}
          />
        </InputWrapper>
      </Content>
    </Secssion>
