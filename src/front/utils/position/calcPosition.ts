...
function cursorInScreenRegion(
  regionPropties: RegionPropties,
  ...
  const cursorIsInsideRegigionX =
    cursorPosition.x >= regionXStartObject &&
    cursorPosition.x <= regionXEndObject;
  const cursorIsInsideRegionY =
    cursorPosition.y >= regionYStartObject &&
    cursorPosition.y <= regionYEndObject;
